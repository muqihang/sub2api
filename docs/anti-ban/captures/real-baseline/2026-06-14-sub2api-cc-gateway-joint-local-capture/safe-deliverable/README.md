...
- Executed at: `2026-06-14T03:25:17-07:00`
...
- sub2api->gateway native shape: `tools=0; thinking=false; context_management=false; output_config_keys=`
...
- gateway->upstream native shape: `tools=0; thinking=false; context_management=false; output_config_keys=`
...
## oauth_native_messages_sign_primary_rich_shape - PASS
- route: `/v1/messages?beta=true`
- decision: `forward_sign_primary_native_rich`
- selected account id ref: `scoped_hmac_ref:key_id=joint_artifact_test;scope=joint_text_ref;version=1;value=redacted`
- egress bucket: `bucket-a`
- policy version: `2.1.175`
- response status: `200`
- request count: `1`
- sub2api shape invariant: `native_body_preserved`
- no real upstream: `true`
- no native fallback: `true`
- sub2api->gateway route: `/v1/messages?beta=true`
- sub2api->gateway body ref: `scoped_hmac_ref:key_id=joint_artifact_test;scope=joint_body_ref;version=1;value=redacted`
- sub2api->gateway billing/cch: `false/false`
- sub2api->gateway native shape: `tools=3; thinking=true; context_management=true; output_config_keys=effort`
- gateway->upstream route: `/v1/messages?beta=true`
- gateway->upstream body ref: `scoped_hmac_ref:key_id=joint_artifact_test;scope=joint_body_ref;version=1;value=redacted`
- gateway->upstream billing/cch: `true/true`
- gateway->upstream native shape: `tools=3; thinking=true; context_management=true; output_config_keys=effort`
- note: `native-attested rich body reaches CC Gateway without Sub2API field downgrade`
- note: `gateway sign-primary final output preserves rich native fields while owning billing/CCH`
