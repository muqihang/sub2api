export default {
  ...
  common: {
    ...
    close: '关闭',
      modelCatalog: '可用模型',
      modelCatalogHint: '当前接入可使用的模型列表',
      billing: '用量与计费',
      billingHint: '统一钱包扣费，按模型计费',
    enabled: '已启用',
    disabled: '已禁用',
	    total: '总计',
	    balance: '余额',
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    augmentOnlyLabel: '仅 Augment',
    augmentOnlyHint: '此密钥仅用于 Augment 流量，并且只能绑定已开通 Augment 的分组。',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
    ...
    groupRequired: '请选择分组',
    augmentGroupRequired: '请选择已开通 Augment 的分组',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
    ...
    useKeyModal: {
      ...
      augmentOnly: {
        title: 'Augment 专用密钥',
        description: '此密钥仅用于独立 Augment 分组和 Augment Gateway 链路，不要把它当成通用的 Codex、Claude Code、Gemini CLI 或 OpenCode 密钥使用。',
        quickLoginNote: '官方 Quick Login 只负责授予官方云 Session，不能替代用户侧必须使用的 Augment 专用 API 密钥。',
        sharedWalletNote: '计费仍然走共享钱包结算，Augment 归因继续落在 Augment 分组和 Augment client_product 上。'
      },
      openai: {
    ...
    zhumengAgent: {
      title: 'Codex 快速接入',
      quickDescription: '使用当前密钥快速接入 Codex 客户端。如需完整管理，请前往 Codex 接入页。',
      quickSetup: '快速接入',
      creating: '生成中...',
      goToEntryPage: '前往 Codex 接入中心 →',
      keyIdRequired: '当前密钥缺少 ID，无法发起快速接入。',
    },
  ...
  affiliate: {
    ...
    tips: {
      title: '使用说明',
      growthTitle: '邀请好友，返利档位越邀越高',
      line1: '将邀请码或邀请链接分享给新用户。',
      line2: '被邀请用户充值后，你可获得 {rate} 的返利额度。',
      line3: '返利额度可随时转入账户余额。',
      line4: '新产生的返利需要经过冻结期后才能提现。',
      tierProgress: '近{days}天有效付费邀请 {count} 人；距离下一档（{threshold} 人）还差 {remaining} 人。',
      inviteeBonus: '被邀请人首笔真实支付可获得 {rate} 加赠。',
      tierTitle: '当前返利档位',
      effectiveCount: '你已有 {count} 位有效付费邀请（统计近{days}天）',
      tierFrom: '{count} 位有效邀请起',
      growthNote: '邀请越多，后续每笔真实支付的返利比例越高；总收益不设上限。'
    }
  },
  ...
  admin: {
    ...
    augmentGateway: {
      ...
      description: '用于管理独立 Augment 分组、Provider 执行分组、官方 Session 池与共享钱包计费可见性的页面。',
      operationalGuidance: '授权分组决定终端用户是否能使用 Augment Gateway；Provider 执行分组只负责实际转发；用户仍需使用独立的 Augment 专用 API 密钥，官方 Quick Login 不能替代该密钥要求。',
      sharedWalletDescription: 'Augment 花费仍然从共享钱包扣减，归因继续落在 Augment 分组和 Augment client_product 上，因此不会改变非 Augment 业务的钱包模型。',
      singleActiveKey: 'Quick Login 和计费摘要只有在用户恰好存在一个启用中的 Augment 专用密钥时，才能自动解析网关密钥。如果存在多个启用中的 Augment 专用密钥，运营侧必须先消除歧义。',
      entitlementGroups: '授权分组',
      entitlementGroupsDescription: '这里列出 augment_gateway_entitled=true 的用户分组。它们只控制谁能使用 Augment Gateway，不决定请求最终落到哪个 Provider 执行池。',
      providerRoutingGroups: 'Provider 执行分组',
      providerRoutingDescription: '每个 Provider 只绑定一个执行分组，用于承载 Augment Gateway 请求。它与用户侧授权分组是两套不同的运营概念。',
      routePolicyVersion: '路由策略版本',
      configuredRoutePolicyVersion: '当前配置路由策略版本',
      executedRoutePolicyVersion: '请求执行路由策略版本',
      manageGroups: '管理分组',
      manageAccounts: '管理账号',
      openQuickLogin: '打开快速登录',
      activePoolSessions: '活跃池 Session',
      healthyPoolSessions: '健康池 Session',
      totalPoolSessions: '池 Session 总数',
      cacheHitRatio: '缓存命中率',
      estimatedCost: '预估费用',
      settledCost: '已结算费用',
      sharedWalletFreeQuota: '共享钱包赠送额度',
      sharedWalletPaidBalance: '共享钱包余额扣费',
      cacheReadTokens: '缓存读取 Tokens',
      sourcePriority: '来源优先级',
      providerGroups: 'Provider 绑定',
      models: '模型',
      modelsDescription: '模型是否可见依赖上方的 Provider 执行分组。只有 smoke 状态通过且定价目录里已有显式价格时，模型才允许在管理端启用。',
      enableModel: '启用',
      disableModel: '停用',
      enabledState: '已启用',
      disabledState: '已停用',
      visibleState: '当前可见',
      notVisibleState: '当前不可见',
      explicitPricingState: '显式定价已就绪',
      missingExplicitPricingState: '缺少显式定价',
      visible: '已显示',
      hidden: '已隐藏',
      officialSessions: '官方 Session',
      sessionPoolDescription: '采集到的平台官方 Session 会进入共享执行池。诊断信息保持脱敏；若想保留记录但让管理员重新处理，优先使用停用或要求重登。',
      capture: '平台会话采集',
      ...
      diagnostics: '诊断',
      usage: '使用记录',
      usageDescription: '最近的 Augment 使用记录会展示请求范围、功能范围、授权分组、Session 关联和路由策略版本，不暴露任何敏感字段。',
      provider: 'Provider',
      group: '分组',
      groupId: '分组 ID',
      health: '健康状态',
      ...
      createdAt: '创建时间',
      savePriority: '保存优先级',
      emptyEntitlementGroups: '当前没有启用 Augment Gateway 授权的活跃分组。',
      emptyUsage: '暂无 Augment Gateway 使用记录。',
    ...
    accounts: {
      ...
      oauth: {
        ...
        grok: {
          title: 'Grok 账号授权',
          followSteps: '请按照以下步骤完成 Grok 账号授权：',
          step1GenerateUrl: '生成授权链接',
          generateAuthUrl: '生成授权链接',
          step2OpenUrl: '在浏览器中打开链接并完成授权',
          openUrlDesc: '请在新标签页中打开授权链接，登录您的 xAI 账号并授权。',
          step3EnterCode: '输入授权链接或 Code',
          authCode: '授权链接或 Code',
          authCodePlaceholder: '粘贴回调链接或授权码',
          ...
          errors: {
            ...
            GROK_OAUTH_INVALID_STATE:
              'Grok OAuth state 与当前会话不匹配。请粘贴同一条授权链接返回的回调 URL。'
          }
        }
      },
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          growthMode: '返利增长模式',
          growthModeLegacy: '固定比例（兼容模式）',
          growthModeTiered: '阶梯增长（90天有效邀请）',
          growthModeHint: '切换前不会改变历史账本。阶梯模式按近90天有效付费邀请人数决定当前比例，档位不叠加。',
          tierWindowDays: '有效邀请统计窗口（天）',
          tierWindowDaysHint: '只有真实支付成功且未全额退款的余额/订阅订单计入，每名被邀请人最多计一次。',
          tierRules: '阶梯规则',
          tierInviteeThreshold: '有效邀请人数 ≥',
          tierRate: '返利比例',
          addTier: '添加档位',
          tierRulesHint: '必须包含从 0 开始的首档；建议使用 0/3/10/25 和 8%/10%/12%/15%。',
          inviteeBonusRate: '被邀请人首充加赠比例',
          inviteeBonusRateHint: '仅首笔真实支付充值发放一次；退款会按比例冲正。',
          effectivePaymentMin: '有效支付最低金额',
          effectivePaymentMinHint: '0 表示不额外限制，仅要求订单净支付大于 0。',
      ...
      gatewayForwarding: {
        ...
        clientDatelineNormalizationHint: '默认开启。将 Anthropic OAuth/Setup Token 请求体中的客户端日期行还原为 ASCII 撇号和短横线日期格式。仅作用于 system prompt 与 <system-reminder> 块，API Key 账号不受影响。',
      ...
      betaPolicy: {
        ...
        userIds: '用户 ID',
        userIdsHint: '留空表示对所有 API Key 所属用户生效。',
  ...
  payment: {
	...
	plugin: {
      ...
      billing: {
        ...
        estimatedCost: '预估费用',
        settledCost: '已结算费用',
        sharedWalletTitle: '共享钱包计费',
        sharedWalletDescription: 'Augment 流量仍然通过共享钱包结算，但使用归因会继续落在独立 Augment 分组和 Augment client_product 上。官方 Quick Login 不能替代必需的 Augment 专用 API 密钥。',
        singleActiveKey: 'Quick Login 摘要自动解析网关密钥时，要求用户恰好只有一个启用中的 Augment 专用密钥；如果存在多个启用中的专用密钥，必须先处理多密钥歧义。',
        sharedWalletFreeQuota: '共享钱包赠送额度',
        sharedWalletPaidBalance: '共享钱包余额扣费',
        attribution: '归因',
        cacheReadTokens: '缓存读取 Tokens',
  ...
  codex: {
    title: 'Codex 接入',
    description: '管理 Codex 客户端接入',
    loading: '正在加载接入状态...',
    retry: '重新加载',
    hero: {
      eyebrow: '逐梦 Codex 接入中心',
      title: '接入 Codex 客户端',
      setupDescription: '在官方 Codex Desktop / CLI 中调用你账户里已开通的模型。完成 3 步，本机就能直接对话。',
      consoleDescription: '你已经有 {count} 台设备接入。这里负责查看状态、补充接入新设备，以及处理异常。',
      notConnected: '未接入',
      awaitingLocal: '等待本机接入',
      syncing: '等待目录同步',
      connected: '已进入控制台',
    },
    wizard: {
      steps: {
        credential: '创建接入凭证',
        credentialSub: '先决定这次接入是新建专用凭证，还是复用现有密钥。',
        attach: '在本机完成接入',
        attachSub: '把这次接入写入本地客户端，不需要手工改配置。',
        verify: '验证模型可用',
        verifySub: '等待首次模型目录同步完成，再进入控制台。',
      },
      step1: {
        title: '先准备这次接入要用的凭证',
        description: '独立页默认帮你走专用接入凭证，也允许改成复用一把现有密钥。页面只负责解释差异，不暴露底层实现。',
        labelTitle: '凭证名称',
        labelPlaceholder: '例如：我的 MacBook',
        labelHint: '只用于你自己识别这次接入，比如「我的 MacBook」或「公司本机」。',
        modeTitle: '选择接入方式',
        modeDescription: '推荐第一次使用时新建一把只给 Codex 用的专用凭证。',
        modeIndependent: '新建 Codex 专用凭证',
        modeIndependentDescription: '状态、设备、吊销都和普通 API 密钥分开管理。第一次接入建议选这个。',
        modeReused: '复用已有 API 密钥',
        modeReusedDescription: '跳过新建，直接复用你现有的一把密钥。状态会和那把密钥共享。',
        startSetup: '开始接入',
        selectKey: '选择要复用的密钥',
        selectKeyPlaceholder: '请选择一把已有密钥',
        selectKeyHint: '请先选择一把现有密钥，再开始接入。',
        selectedKeyHint: '当前将复用：{name}',
        footerHint: '如果你之后还想在别的电脑接入，可以在控制台里继续添加新设备，不会把整页拉回第一次向导。',
        sideWhatTitle: '这次接入会做什么',
        sideWhatBody: '在你账户里登记一台 Codex 设备，并把当前可用的模型同步给本机。计费仍然按所用模型的标准价格，从当前钱包余额扣减。',
        sideNoChangeTitle: '不会改动什么',
        sideNoChangeBody: '不会改你已有的 API 密钥，也不会替你切换分组或迁移余额。之后想停用时，你可以按设备或按凭证分别处理。',
        sideEnvTitle: '需要的本机环境',
        sideEnvBody: '支持官方 Codex Desktop / CLI。客户端过旧时，后续控制台会直接提示升级，不会把你卡在不明所以的报错里。',
      },
      step2: {
        title: '在本机完成接入',
        description: '这一页只负责把接入信息交给本地客户端。你可以直接打开本机客户端，也可以复制命令行方式手工完成。',
        launchLabel: '第 2 步 · 本机接入',
        launchTitle: '打开本机客户端继续',
        launchDescription: '优先使用图形客户端打开。命令行方式适合你已经在终端里使用 Codex CLI 的情况。',
        pendingBadge: '等待本机确认',
        openLocal: '打开本机客户端',
        regenerateAndOpen: '重新生成并打开本机客户端',
        copyCli: '复制 CLI 命令',
        cliTitle: '命令行接入',
        regenerate: '重新生成接入码',
        diagnose: '查看接入诊断',
        diagnosing: '正在诊断...',
        backToCredential: '返回选择接入方式',
        helpTitle: '如果刚才没有弹起客户端',
        helpItem1: '先确认本机已经安装并登录官方 Codex 客户端。',
        helpItem2: '如果浏览器拦截了打开请求，可以改用 CLI 命令继续。',
        helpItem3: '诊断入口只读，不会改动你本机或服务器状态。',
        sessionLabel: '本次接入名称',
        expiresLabel: '当前接入码到期时间',
      },
      step3: {
        title: '等待首次模型目录同步',
        description: '客户端已经开始接入。接下来只等第一份模型目录同步完成，完成后页面会自动切换到控制台。',
        verifying: '同步进行中',
        panelTitle: '正在验证模型是否已出现在客户端里',
        panelDescription: '这一阶段的技术退出条件是首次模型目录同步完成。也就是 setup session 已经拿到 first_catalog_synced_at。',
        refresh: '刷新状态',
        diagnose: '查看诊断',
        diagnosing: '正在诊断...',
        reopenLocal: '重新打开客户端',
        regenerateAndReopen: '重新生成并打开客户端',
        exitTitle: '页面何时自动进入控制台',
        exitDescription: '当这次接入记录首次出现模型目录同步时间时，说明客户端已经拿到第一份模型清单，这一页就会结束向导态。',
      },
    },
    console: {
      title: 'Codex 控制台',
      description: '你当前有 {count} 台设备接入。主动作是接入新设备，设备级修复和诊断都在下面分开管理。',
      addDevice: '接入新设备',
      bannerLabel: '控制台内继续接入',
      newDeviceInProgress: '新设备接入中',
      bannerDescription: '你已经有设备在用，所以页面保持控制台形态，只在这里提示另一台新设备还在接入中。',
      openLocal: '打开客户端',
      regenerateAndOpen: '重新生成并打开客户端',
      copyCli: '复制命令',
      stateHealthy: '当前设备正常',
      stateCatalogStale: '模型目录需要刷新',
      stateOffline: '设备当前离线',
      stateAttention: '当前设备需要处理',
      statePending: '等待状态更新',
      devices: '已接入设备',
      devicesDescription: '这里展示每台设备自己的状态。设备异常不会把整页重新切回第一次向导。',
      noDevices: '当前还没有已接入设备。',
      resync: '重新同步',
      repair: '尝试修复',
      diagnose: '查看诊断',
      reattach: '重新接入此设备',
      removeDevice: '断开设备',
      removeDeviceOnly: '仅移除此设备',
      upgradeClient: '查看升级指引',
      revokeCredential: '吊销该接入凭证',
      disconnectDevice: '断开此设备',
      troubleshoot: '故障排查',
      troubleshootDescription: '这里只放修复和诊断两个入口，不把它们混成一个万能按钮。',
      diagnoseTitle: '接入诊断',
      diagnoseDescription: '下面是这次诊断返回的结构化检查结果。',
      diagnoseOk: '所有检查项正常',
      diagnoseFail: '发现异常，请按提示逐项处理',
      close: '关闭',
      modelCatalog: '可用模型',
      modelCatalogHint: '展示当前 Codex 网关已经开放给 Codex App 的模型目录。',
      modelCatalogEmpty: '暂时还没有拿到模型目录摘要，你仍然可以先完成接入与状态排查。',
      billing: '用量与计费',
      billingHint: '统一钱包扣费，按模型计费。这个解释要直给，不像技术说明书。',
      balanceLabel: '当前钱包余额',
      billingRuleLabel: '扣费方式',
      billingRuleBody: '仍然走你现在账户的钱包扣费；不同模型按各自价格结算。',
      reuseSourceLabel: '和接入凭证的关系',
      reuseSourceBody: '无论是专用接入凭证还是复用密钥，计费都不改，只是接入关系不同。',
      topUpCta: '前往充值 / 购买',
      pricingPending: '按模型定价',
      pricingBillingMode: '计费方式',
      pricingSource: '价格来源',
      unitPerRequest: '/ 次',
      perRequestPrice: '单次价格',
      cacheWritePrice: '缓存写入',
      cacheReadPrice: '命中缓存',
      pricingIntervals: '分层价格',
      pricingSourceLabels: {
        channel: '渠道定价',
        litellm: '模型价格库',
        fallback: '系统兜底价',
      },
      deviceHealthyTitle: '这台设备状态正常',
      deviceHealthyBody: '心跳正常，模型目录已经同步完成。你可以继续同步或查看诊断。',
      deviceCatalogStaleTitle: '模型目录需要重新同步',
      deviceCatalogStaleBody: '设备在线，但最新模型目录没有及时刷新。主动作是重新同步，不是修复客户端。',
      deviceOfflineTitle: '这台设备暂时离线',
      deviceOfflineBody: '先尝试自动修复；如果仍无响应，再看诊断结果。修复和诊断永远是两个独立动作。',
      deviceCredentialRevokedTitle: '接入凭证已失效',
      deviceCredentialRevokedBody: '这不是单纯离线，而是接入关系本身失效。主动作应当是重新接入，不是尝试修复。',
      deviceClientOutdatedTitle: '客户端版本过旧',
      deviceClientOutdatedBody: '先升级本机客户端版本，再重新查看状态。',
      deviceStateLabels: {
        healthy: '正常',
        catalog_stale: '目录待刷新',
        device_offline: '设备离线',
        credential_revoked: '凭证失效',
        client_outdated: '客户端过旧',
      },
      billingModes: {
        token: '按 Token 计费',
        per_request: '按次计费',
