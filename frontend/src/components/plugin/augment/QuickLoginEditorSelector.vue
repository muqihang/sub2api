  ...
  <section class="space-y-3">
    ...
    <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
      <button
        ...
        type="button"
        class="flex min-h-16 items-center justify-center rounded-lg border px-4 py-3 text-center text-sm font-medium transition focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-dark-900"
