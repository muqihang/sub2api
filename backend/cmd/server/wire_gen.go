...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	rateLimitService := service.ProvideRateLimitService(accountRepository, usageLogRepository, configConfig, geminiQuotaService, tempUnschedCache, timeoutCounterCache, settingService, compositeTokenCacheInvalidator, oAuthRefreshAPI, openAIOAuthService)
	...
	openAIGatewayCoreService := service.NewOpenAIGatewayCoreService(accountRepository, configConfig, openAITokenProvider)
	openAIOAuthService.SetGatewayCoreService(openAIGatewayCoreService)
	openAIGatewayService := service.NewOpenAIGatewayService(accountRepository, usageLogRepository, usageBillingRepository, userRepository, userSubscriptionRepository, userGroupRateRepository, gatewayCache, configConfig, schedulerSnapshotService, concurrencyService, billingService, rateLimitService, billingCacheService, httpUpstream, deferredService, openAITokenProvider, openAIGatewayCoreService, modelPricingResolver, channelService, balanceNotifyService)
	...
	openAIGatewayHandler := handler.NewOpenAIGatewayHandler(openAIGatewayService, openAIGatewayCoreService, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, configConfig)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, codexAgentHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, idempotencyCoordinator, idempotencyCleanupService)
