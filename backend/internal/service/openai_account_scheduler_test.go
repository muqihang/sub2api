...
func (c *schedulerTestGatewayCache) IncrModelCallCount(ctx context.Context, accountID int64, model string) (int64, error) {
	return 0, nil
}

func (c *schedulerTestGatewayCache) GetModelLoadBatch(ctx context.Context, accountIDs []int64, model string) (map[int64]*ModelLoadInfo, error) {
	return nil, nil
}

func (c *schedulerTestGatewayCache) RecordOpenAICacheSample(ctx context.Context, accountID int64, model string, inputTokens int64, cacheReadTokens int64) error {
	return nil
}

func (c *schedulerTestGatewayCache) GetOpenAICacheHealthBatch(ctx context.Context, accountIDs []int64, model string) (map[int64]*OpenAICacheHealthInfo, error) {
	return nil, nil
}

func (c *schedulerTestGatewayCache) FindGeminiSession(ctx context.Context, groupID int64, prefixHash, digestChain string) (uuid string, accountID int64, found bool) {
	return "", 0, false
}

func (c *schedulerTestGatewayCache) SaveGeminiSession(ctx context.Context, groupID int64, prefixHash, digestChain, uuid string, accountID int64) error {
	return nil
}
...
func TestOpenAIGatewayService_SelectAccountWithSchedulerForGrokMedia_AdvancedSchedulerUsesGrokPlatform(t *testing.T) {
	resetOpenAIAdvancedSchedulerSettingCacheForTest()
	...
	selection, decision, err := svc.SelectAccountWithSchedulerForGrokMedia(ctx, &groupID, "grok-session", "grok-imagine-image-quality", nil)

	require.NoError(t, err)
	require.NotNil(t, selection)
	require.NotNil(t, selection.Account)
	require.Equal(t, int64(92002), selection.Account.ID)
...
func TestOpenAIGatewayService_SchedulerWrappersAndDefaults(t *testing.T) {
	...
	cfg.Gateway.OpenAIWS.SchedulerScoreWeights.QuotaHeadroom = 0.8
	...
	require.Equal(t, 0.8, customWeights.QuotaHeadroom)
}
