...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	openAIGatewayCoreService := service.ProvideOpenAIGatewayCoreService(accountRepository, configConfig, openAITokenProvider, openAIOAuthService)
