...
class ManagedProxyServer:
    ...
    def create_app(self) -> web.Application:
        ...
        app.router.add_route("*", "/v1/chat/completions", self.handle_request)
    ...
    async def handle_request(self, request: web.Request) -> web.StreamResponse:
        ...
        if request.path not in {"/v1/responses", "/v1/chat/completions", "/v1/models"} and not request.path.startswith("/v1/responses/"):
            raise web.HTTPNotFound()
