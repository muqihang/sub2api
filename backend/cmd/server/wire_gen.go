...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountUsageService := service.ProvideAccountUsageService(accountRepository, usageLogRepository, claudeUsageFetcher, geminiQuotaService, antigravityQuotaFetcher, usageCache, identityCache, tlsFingerprintProfileService, configConfig)
	...
	openAIOAuthHandler := admin.NewOpenAIOAuthHandler(openAIOAuthService, openAIGatewayService, adminService)
	...
	codexGatewayModelRegistry := service.ProvideCodexGatewayModelRegistry(configConfig)
	codexGatewayStateStore := service.ProvideCodexGatewayStateStore(configConfig)
	codexGatewayProviderExecutor := service.ProvideCodexGatewayProviderExecutor(configConfig, openAIGatewayService, codexGatewayStateStore)
	codexGatewayService := service.ProvideCodexGatewayService(codexGatewayModelRegistry, codexGatewayProviderExecutor)
	codexGatewayHandler := handler.ProvideCodexGatewayHandler(codexGatewayService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, codexGatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
