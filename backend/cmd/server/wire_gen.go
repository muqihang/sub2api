...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	augmentPluginService := service.NewAugmentPluginService(configConfig, authService, userService, apiKeyService, subscriptionService, settingService)
	authHandler := handler.NewAuthHandler(configConfig, authService, userService, settingService, promoService, redeemService, totpService, augmentPluginService)
	...
	openAIOAuthSessionStore, err := service.ProvideOpenAIOAuthSessionStore(redisClient, configConfig)
	if err != nil {
		return nil, err
	}
	openAIOAuthService := service.ProvideOpenAIOAuthService(proxyRepository, openAIOAuthClient, openAIOAuthSessionStore)
	...
	openAIGatewayCoreService := service.NewOpenAIGatewayCoreService(accountRepository, configConfig, openAITokenProvider, tlsFingerprintProfileService)
	openAIOAuthService.SetGatewayCoreService(openAIGatewayCoreService)
