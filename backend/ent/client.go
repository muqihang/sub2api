...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.CodexDeviceAuditLog, c.CodexDeviceToken, c.CodexManagedDevice,
		c.CodexSetupGrant, c.ErrorPassthroughRule, c.Group, c.IdempotencyRecord,
...
type (
	hooks struct {
		...
		ChannelMonitorRequestTemplate, CodexDeviceAuditLog, CodexDeviceToken,
		CodexManagedDevice, CodexSetupGrant, ErrorPassthroughRule, Group,
