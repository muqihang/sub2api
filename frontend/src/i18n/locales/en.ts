  ...
  plugin: {
    augment: {
      ...
      quickLogin: {
        ...
        subtitle: 'Finish the browser step, then hand the grant back to VS Code.',
        emptyState: 'Open this page from the Augment extension so the login grant context is available.',
        missingContext: 'Missing quick login parameters. Re-open this page from the Augment extension and try again.',
        continue: 'Continue in VS Code',
        requesting: 'Preparing VS Code handoff...',
        launch: 'Launch VS Code',
        copy: 'Copy Deeplink',
        ready: 'VS Code deeplink is ready.',
        copySuccess: 'VS Code deeplink copied',
        requestFailed: 'Unable to prepare Augment quick login right now.',
        missingDeeplink: 'Backend grant response did not include a VS Code deeplink.',
      },
    },
  },
