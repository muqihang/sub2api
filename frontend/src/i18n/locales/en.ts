export default {
  ...
  admin: {
    ...
    augmentGateway: {
      ...
      description: 'Admin surface for Augment entitlement groups, provider execution pools, official session capacity, and billing visibility.',
      operationalGuidance: 'Entitlement groups grant end-user access. Provider routing groups are execution pools only. Official sessions stay redacted and should be managed through capture, disable, relogin, and revoke actions.',
      ...
      models: 'Models',
      modelsDescription: 'Visible models inherit provider execution from the routing groups above. Smoke status must pass before a model can be enabled for admins to expose.',
      enableModel: 'Enable',
