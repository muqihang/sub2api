...
func (c StubGatewayCache) RecordOpenAICacheSample(_ context.Context, _ int64, _ string, _, _ int64) error {
	return nil
}
func (c StubGatewayCache) GetOpenAICacheHealthBatch(_ context.Context, _ []int64, _ string) (map[int64]*service.OpenAICacheHealthInfo, error) {
	return nil, nil
}
